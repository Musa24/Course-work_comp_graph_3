...
void RenderGUI(OpenGL* ogl)
{
	...
	std::stringstream ss;
	ss << "W - DRIVING FORWARD" << std::endl;
	ss << "S - DRIVING BACKWARD" << std::endl;
	ss << "U - SPEED SHADOW" << std::endl;
	ss << "A - DRIVING RIGHT" << std::endl;
	ss << "L - CAR HIGLIGHT" << std::endl;
	ss << "CAR SPEED = " << car.ReturnSpeed() << std::endl;
	ss << "CAR COLLISION = " << tmp << std::endl;
